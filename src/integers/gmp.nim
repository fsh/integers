## This code is largely copied from the 8yo (defunct?) "nim-gmp" package under
## MIT license. Credit is as follows:
##
## Nim GMP wrapper (c) Copyright 2014 Will Szumski
##
## Modifications include some cleanup (ongoing project) and removing the
## randstate stuff.

{.passl: "-lgmp".}

type 
  # How to import a pure typedef from a C header in Nim?
  ...
  mpz_struct* {.byref, importc: "__mpz_struct", header: "<gmp.h>".} = object
...
type
  mpq_struct* {.byref, importc: "__mpq_struct", header: "<gmp.h>".} = object
    mp_num* {.importc: "_mp_num".}: mpz_struct
    mp_den* {.importc: "_mp_den".}: mpz_struct

  mpq_t* = mpq_struct
  mpf_struct* {.byref, importc: "__mpf_struct", header: "<gmp.h>".} = object
  ...
  mpz_srcptr* = ptr mpz_struct
  mpz_ptr* = ptr mpz_struct
  mpf_srcptr* = ptr mpf_struct
  mpf_ptr* = ptr mpf_struct
  mpq_srcptr* = ptr mpq_struct
  mpq_ptr* = ptr mpq_struct


proc mpq_numref*(a2: mpq_ptr): mpz_ptr {.importc: "mpq_numref", header: "<gmp.h>".}
proc mpq_numref*(a2: var mpq_t): mpz_ptr {.importc: "mpq_numref", header: "<gmp.h>".}
proc mpq_denref*(a2: mpq_ptr): mpz_ptr {.importc: "mpq_denref", header: "<gmp.h>".}
proc mpq_denref*(a2: var mpq_t): mpz_ptr {.importc: "mpq_denref", header: "<gmp.h>".}
proc mp_set_memory_functions*(a2: proc (a2: csize_t): pointer; a3: proc (a2: pointer; a3: csize_t; a4: csize_t): pointer;
                              a4: proc (a2: pointer; a3: csize_t)) {. importc: "mp_set_memory_functions", header: "<gmp.h>".}
proc mp_get_memory_functions*(a2: proc (a2: csize_t): pointer;
     a3: proc (a2: pointer; a3: csize_t; a4: csize_t): pointer; a4: proc (a2: pointer; a3: csize_t)) {.
...
#     header: "<gmp.h>".}
# proc gmp_randinit_set*(a2: gmp_randstate_t; a3: ptr gmp_randstate_struct) {.
...
proc mpz_add*(a2: mpz_ptr; a3: mpz_srcptr; a4: mpz_srcptr) {.importc: "mpz_add", header: "<gmp.h>".}
proc mpz_add*(a2: var mpz_t; a3: mpz_t; a4: mpz_t) {.importc: "mpz_add", header: "<gmp.h>".}
proc mpz_add_ui*(a2: mpz_ptr; a3: mpz_srcptr; a4: culong) {. importc: "mpz_add_ui", header: "<gmp.h>".}
proc mpz_add_ui*(a2: var mpz_t; a3: mpz_t; a4: culong) {.importc: "mpz_add_ui", header: "<gmp.h>".}
proc mpz_addmul*(a2: mpz_ptr; a3: mpz_srcptr; a4: mpz_srcptr) {. importc: "mpz_addmul", header: "<gmp.h>".}
proc mpz_addmul*(a2: var mpz_t; a3: mpz_t; a4: mpz_t) {.importc: "mpz_addmul", header: "<gmp.h>".}
proc mpz_addmul_ui*(a2: mpz_ptr; a3: mpz_srcptr; a4: culong) {. importc: "mpz_addmul_ui", header: "<gmp.h>".}
proc mpz_addmul_ui*(a2: var mpz_t; a3: mpz_t; a4: culong) {. importc: "mpz_addmul_ui", header: "<gmp.h>".}
proc mpz_and*(a2: mpz_ptr; a3: mpz_srcptr; a4: mpz_srcptr) {.importc: "mpz_and", header: "<gmp.h>".}
proc mpz_and*(a2: var mpz_t; a3: mpz_t; a4: mpz_t) {.importc: "mpz_and", header: "<gmp.h>".}
proc mpz_array_init*(a2: mpz_ptr; a3: mp_size_t; a4: mp_size_t) {. importc: "mpz_array_init", header: "<gmp.h>".}
proc mpz_array_init*(a2: var mpz_t; a3: mp_size_t; a4: mp_size_t) {. importc: "mpz_array_init", header: "<gmp.h>".}
proc mpz_bin_ui*(a2: mpz_ptr; a3: mpz_srcptr; a4: culong) {. importc: "mpz_bin_ui", header: "<gmp.h>".}
proc mpz_bin_ui*(a2: var mpz_t; a3: mpz_t; a4: culong) {.importc: "mpz_bin_ui", header: "<gmp.h>".}
proc mpz_bin_uiui*(a2: mpz_ptr; a3: culong; a4: culong) {. importc: "mpz_bin_uiui", header: "<gmp.h>".}
proc mpz_bin_uiui*(a2: var mpz_t; a3: culong; a4: culong) {. importc: "mpz_bin_uiui", header: "<gmp.h>".}
proc mpz_cdiv_q*(a2: mpz_ptr; a3: mpz_srcptr; a4: mpz_srcptr) {. importc: "mpz_cdiv_q", header: "<gmp.h>".}
proc mpz_cdiv_q*(a2: var mpz_t; a3: mpz_t; a4: mpz_t) {.importc: "mpz_cdiv_q", header: "<gmp.h>".}
proc mpz_cdiv_q_2exp*(a2: mpz_ptr; a3: mpz_srcptr; a4: mp_bitcnt_t) {. importc: "mpz_cdiv_q_2exp", header: "<gmp.h>".}
proc mpz_cdiv_q_2exp*(a2: var mpz_t; a3: mpz_t; a4: mp_bitcnt_t) {. importc: "mpz_cdiv_q_2exp", header: "<gmp.h>".}
proc mpz_cdiv_q_ui*(a2: mpz_ptr; a3: mpz_srcptr; a4: culong): culong {. importc: "mpz_cdiv_q_ui", header: "<gmp.h>".}
proc mpz_cdiv_q_ui*(a2: var mpz_t; a3: mpz_t; a4: culong): culong {. importc: "mpz_cdiv_q_ui", header: "<gmp.h>".}
proc mpz_cdiv_qr*(a2: mpz_ptr; a3: mpz_ptr; a4: mpz_srcptr; a5: mpz_srcptr) {. importc: "mpz_cdiv_qr", header: "<gmp.h>".}
proc mpz_cdiv_qr*(a2: var mpz_t; a3: var mpz_t; a4: mpz_t; a5: mpz_t) {. importc: "mpz_cdiv_qr", header: "<gmp.h>".}
proc mpz_cdiv_qr_ui*(a2: mpz_ptr; a3: mpz_ptr; a4: mpz_srcptr; a5: culong): culong {. importc: "mpz_cdiv_qr_ui", header: "<gmp.h>".}
proc mpz_cdiv_qr_ui*(a2: var mpz_t; a3: var mpz_t; a4: mpz_t; a5: culong): culong {. importc: "mpz_cdiv_qr_ui", header: "<gmp.h>".}
proc mpz_cdiv_r*(a2: mpz_ptr; a3: mpz_srcptr; a4: mpz_srcptr) {. importc: "mpz_cdiv_r", header: "<gmp.h>".}
proc mpz_cdiv_r*(a2: var mpz_t; a3: mpz_t; a4: mpz_t) {.importc: "mpz_cdiv_r", header: "<gmp.h>".}
proc mpz_cdiv_r_2exp*(a2: mpz_ptr; a3: mpz_srcptr; a4: mp_bitcnt_t) {. importc: "mpz_cdiv_r_2exp", header: "<gmp.h>".}
proc mpz_cdiv_r_2exp*(a2: var mpz_t; a3: mpz_t; a4: mp_bitcnt_t) {. importc: "mpz_cdiv_r_2exp", header: "<gmp.h>".}
proc mpz_cdiv_r_ui*(a2: mpz_ptr; a3: mpz_srcptr; a4: culong): culong {. importc: "mpz_cdiv_r_ui", header: "<gmp.h>".}
proc mpz_cdiv_r_ui*(a2: var mpz_t; a3: mpz_t; a4: culong): culong {. importc: "mpz_cdiv_r_ui", header: "<gmp.h>".}
proc mpz_cdiv_ui*(a2: mpz_srcptr; a3: culong): culong {.importc: "mpz_cdiv_ui", header: "<gmp.h>".}
proc mpz_cdiv_ui*(a2: mpz_t; a3: culong): culong {.importc: "mpz_cdiv_ui", header: "<gmp.h>".}
proc mpz_clear*(a2: mpz_ptr) {.importc: "mpz_clear", header: "<gmp.h>".}
proc mpz_clear*(a2: var mpz_t) {.importc: "mpz_clear", header: "<gmp.h>".}
proc mpz_clears*(a2: mpz_ptr) {.varargs, importc: "mpz_clears", header: "<gmp.h>".}
proc mpz_clears*(a2: var mpz_t) {.varargs, importc: "mpz_clears", header: "<gmp.h>".}
proc mpz_clrbit*(a2: mpz_ptr; a3: mp_bitcnt_t) {.importc: "mpz_clrbit", header: "<gmp.h>".}
proc mpz_clrbit*(a2: var mpz_t; a3: mp_bitcnt_t) {.importc: "mpz_clrbit", header: "<gmp.h>".}
proc mpz_cmp*(a2: mpz_srcptr; a3: mpz_srcptr): cint {.importc: "mpz_cmp", header: "<gmp.h>".}
proc mpz_cmp*(a2: mpz_t; a3: mpz_t): cint {.importc: "mpz_cmp", header: "<gmp.h>".}
proc mpz_cmp_d*(a2: mpz_srcptr; a3: cdouble): cint {.importc: "mpz_cmp_d", header: "<gmp.h>".}
proc mpz_cmp_d*(a2: mpz_t; a3: cdouble): cint {.importc: "mpz_cmp_d", header: "<gmp.h>".}
proc mpz_cmp_si*(a2: mpz_srcptr; a3: clong): cint {.importc: "_mpz_cmp_si", header: "<gmp.h>".}
proc mpz_cmp_si*(a2: mpz_t; a3: clong): cint {.importc: "_mpz_cmp_si", header: "<gmp.h>".}
proc mpz_cmp_ui*(a2: mpz_srcptr; a3: culong): cint {.importc: "_mpz_cmp_ui", header: "<gmp.h>".}
proc mpz_cmp_ui*(a2: mpz_t; a3: culong): cint {.importc: "_mpz_cmp_ui", header: "<gmp.h>".}
proc mpz_cmpabs*(a2: mpz_srcptr; a3: mpz_srcptr): cint {.importc: "mpz_cmpabs", header: "<gmp.h>".}
proc mpz_cmpabs*(a2: mpz_t; a3: mpz_t): cint {.importc: "mpz_cmpabs", header: "<gmp.h>".}
proc mpz_cmpabs_d*(a2: mpz_srcptr; a3: cdouble): cint {.importc: "mpz_cmpabs_d", header: "<gmp.h>".}
proc mpz_cmpabs_d*(a2: mpz_t; a3: cdouble): cint {.importc: "mpz_cmpabs_d", header: "<gmp.h>".}
proc mpz_cmpabs_ui*(a2: mpz_srcptr; a3: culong): cint {. importc: "mpz_cmpabs_ui", header: "<gmp.h>".}
proc mpz_cmpabs_ui*(a2: mpz_t; a3: culong): cint {.importc: "mpz_cmpabs_ui", header: "<gmp.h>".}
proc mpz_com*(a2: mpz_ptr; a3: mpz_srcptr) {.importc: "mpz_com", header: "<gmp.h>".}
proc mpz_com*(a2: var mpz_t; a3: mpz_t) {.importc: "mpz_com", header: "<gmp.h>".}
proc mpz_combit*(a2: mpz_ptr; a3: mp_bitcnt_t) {.importc: "mpz_combit", header: "<gmp.h>".}
proc mpz_combit*(a2: var mpz_t; a3: mp_bitcnt_t) {.importc: "mpz_combit", header: "<gmp.h>".}
proc mpz_congruent_p*(a2: mpz_srcptr; a3: mpz_srcptr; a4: mpz_srcptr): cint {. importc: "mpz_congruent_p", header: "<gmp.h>".}
proc mpz_congruent_p*(a2: mpz_t; a3: mpz_t; a4: mpz_t): cint {. importc: "mpz_congruent_p", header: "<gmp.h>".}
proc mpz_congruent_2exp_p*(a2: mpz_srcptr; a3: mpz_srcptr; a4: mp_bitcnt_t): cint {. importc: "mpz_congruent_2exp_p", header: "<gmp.h>".}
proc mpz_congruent_2exp_p*(a2: mpz_t; a3: mpz_t; a4: mp_bitcnt_t): cint {. importc: "mpz_congruent_2exp_p", header: "<gmp.h>".}
proc mpz_congruent_ui_p*(a2: mpz_srcptr; a3: culong; a4: culong): cint {. importc: "mpz_congruent_ui_p", header: "<gmp.h>".}
proc mpz_congruent_ui_p*(a2: mpz_t; a3: culong; a4: culong): cint {. importc: "mpz_congruent_ui_p", header: "<gmp.h>".}
proc mpz_divexact*(a2: mpz_ptr; a3: mpz_srcptr; a4: mpz_srcptr) {. importc: "mpz_divexact", header: "<gmp.h>".}
proc mpz_divexact*(a2: var mpz_t; a3: mpz_t; a4: mpz_t) {. importc: "mpz_divexact", header: "<gmp.h>".}
proc mpz_divexact_ui*(a2: mpz_ptr; a3: mpz_srcptr; a4: culong) {. importc: "mpz_divexact_ui", header: "<gmp.h>".}
proc mpz_divexact_ui*(a2: var mpz_t; a3: mpz_t; a4: culong) {. importc: "mpz_divexact_ui", header: "<gmp.h>".}
proc mpz_divisible_p*(a2: mpz_srcptr; a3: mpz_srcptr): cint {. importc: "mpz_divisible_p", header: "<gmp.h>".}
proc mpz_divisible_p*(a2: mpz_t; a3: mpz_t): cint {.importc: "mpz_divisible_p", header: "<gmp.h>".}
proc mpz_divisible_ui_p*(a2: mpz_srcptr; a3: culong): cint {. importc: "mpz_divisible_ui_p", header: "<gmp.h>".}
proc mpz_divisible_ui_p*(a2: mpz_t; a3: culong): cint {. importc: "mpz_divisible_ui_p", header: "<gmp.h>".}
proc mpz_divisible_2exp_p*(a2: mpz_srcptr; a3: mp_bitcnt_t): cint {. importc: "mpz_divisible_2exp_p", header: "<gmp.h>".}
proc mpz_divisible_2exp_p*(a2: mpz_t; a3: mp_bitcnt_t): cint {. importc: "mpz_divisible_2exp_p", header: "<gmp.h>".}
proc mpz_dump*(a2: mpz_srcptr) {.importc: "mpz_dump", header: "<gmp.h>".}
proc mpz_dump*(a2: mpz_t) {.importc: "mpz_dump", header: "<gmp.h>".}
proc mpz_export*(a2: pointer; a3: ptr csize_t; a4: cint; a5: csize_t; a6: cint; a7: csize_t; a8: mpz_srcptr): pointer {.importc: "mpz_export", header: "<gmp.h>".}
proc mpz_export*(a2: pointer; a3: ptr csize_t; a4: cint; a5: csize_t; a6: cint; a7: csize_t; a8: mpz_t): pointer {.importc: "mpz_export", header: "<gmp.h>".}
proc mpz_fac_ui*(a2: mpz_ptr; a3: culong) {.importc: "mpz_fac_ui", header: "<gmp.h>".}
proc mpz_fac_ui*(a2: var mpz_t; a3: culong) {.importc: "mpz_fac_ui", header: "<gmp.h>".}
proc mpz_2fac_ui*(a2: mpz_ptr; a3: culong) {.importc: "mpz_2fac_ui", header: "<gmp.h>".}
proc mpz_2fac_ui*(a2: var mpz_t; a3: culong) {.importc: "mpz_2fac_ui", header: "<gmp.h>".}
proc mpz_mfac_uiui*(a2: mpz_ptr; a3: culong; a4: culong) {. importc: "mpz_mfac_uiui", header: "<gmp.h>".}
proc mpz_mfac_uiui*(a2: var mpz_t; a3: culong; a4: culong) {. importc: "mpz_mfac_uiui", header: "<gmp.h>".}
proc mpz_primorial_ui*(a2: mpz_ptr; a3: culong) {.importc: "mpz_primorial_ui", header: "<gmp.h>".}
proc mpz_primorial_ui*(a2: var mpz_t; a3: culong) {.importc: "mpz_primorial_ui", header: "<gmp.h>".}
proc mpz_fdiv_q*(a2: mpz_ptr; a3: mpz_srcptr; a4: mpz_srcptr) {. importc: "mpz_fdiv_q", header: "<gmp.h>".}
proc mpz_fdiv_q*(a2: var mpz_t; a3: mpz_t; a4: mpz_t) {.importc: "mpz_fdiv_q", header: "<gmp.h>".}
proc mpz_fdiv_q_2exp*(a2: mpz_ptr; a3: mpz_srcptr; a4: mp_bitcnt_t) {. importc: "mpz_fdiv_q_2exp", header: "<gmp.h>".}
proc mpz_fdiv_q_2exp*(a2: var mpz_t; a3: mpz_t; a4: mp_bitcnt_t) {. importc: "mpz_fdiv_q_2exp", header: "<gmp.h>".}
proc mpz_fdiv_q_ui*(a2: mpz_ptr; a3: mpz_srcptr; a4: culong): culong {. importc: "mpz_fdiv_q_ui", header: "<gmp.h>".}
proc mpz_fdiv_q_ui*(a2: var mpz_t; a3: mpz_t; a4: culong): culong {. importc: "mpz_fdiv_q_ui", header: "<gmp.h>".}
proc mpz_fdiv_qr*(a2: mpz_ptr; a3: mpz_ptr; a4: mpz_srcptr; a5: mpz_srcptr) {. importc: "mpz_fdiv_qr", header: "<gmp.h>".}
proc mpz_fdiv_qr*(a2: var mpz_t; a3: var mpz_t; a4: mpz_t; a5: mpz_t) {. importc: "mpz_fdiv_qr", header: "<gmp.h>".}
proc mpz_fdiv_qr_ui*(a2: mpz_ptr; a3: mpz_ptr; a4: mpz_srcptr; a5: culong): culong {. importc: "mpz_fdiv_qr_ui", header: "<gmp.h>".}
proc mpz_fdiv_qr_ui*(a2: var mpz_t; a3: var mpz_t; a4: mpz_t; a5: culong): culong {. importc: "mpz_fdiv_qr_ui", header: "<gmp.h>".}
proc mpz_fdiv_r*(a2: mpz_ptr; a3: mpz_srcptr; a4: mpz_srcptr) {. importc: "mpz_fdiv_r", header: "<gmp.h>".}
proc mpz_fdiv_r*(a2: var mpz_t; a3: mpz_t; a4: mpz_t) {.importc: "mpz_fdiv_r", header: "<gmp.h>".}
proc mpz_fdiv_r_2exp*(a2: mpz_ptr; a3: mpz_srcptr; a4: mp_bitcnt_t) {. importc: "mpz_fdiv_r_2exp", header: "<gmp.h>".}
proc mpz_fdiv_r_2exp*(a2: var mpz_t; a3: mpz_t; a4: mp_bitcnt_t) {. importc: "mpz_fdiv_r_2exp", header: "<gmp.h>".}
proc mpz_fdiv_r_ui*(a2: mpz_ptr; a3: mpz_srcptr; a4: culong): culong {. importc: "mpz_fdiv_r_ui", header: "<gmp.h>".}
proc mpz_fdiv_r_ui*(a2: var mpz_t; a3: mpz_t; a4: culong): culong {. importc: "mpz_fdiv_r_ui", header: "<gmp.h>".}
proc mpz_fdiv_ui*(a2: mpz_srcptr; a3: culong): culong {.importc: "mpz_fdiv_ui", header: "<gmp.h>".}
proc mpz_fdiv_ui*(a2: mpz_t; a3: culong): culong {.importc: "mpz_fdiv_ui", header: "<gmp.h>".}
proc mpz_fib_ui*(a2: mpz_ptr; a3: culong) {.importc: "mpz_fib_ui", header: "<gmp.h>".}
proc mpz_fib_ui*(a2: var mpz_t; a3: culong) {.importc: "mpz_fib_ui", header: "<gmp.h>".}
proc mpz_fib2_ui*(a2: mpz_ptr; a3: mpz_ptr; a4: culong) {. importc: "mpz_fib2_ui", header: "<gmp.h>".}
proc mpz_fib2_ui*(a2: var mpz_t; a3: var mpz_t; a4: culong) {. importc: "mpz_fib2_ui", header: "<gmp.h>".}
proc mpz_fits_sint_p*(a2: mpz_srcptr): cint {.importc: "mpz_fits_sint_p", header: "<gmp.h>".}
proc mpz_fits_sint_p*(a2: mpz_t): cint {.importc: "mpz_fits_sint_p", header: "<gmp.h>".}
proc mpz_fits_slong_p*(a2: mpz_srcptr): cint {.importc: "mpz_fits_slong_p", header: "<gmp.h>".}
proc mpz_fits_slong_p*(a2: mpz_t): cint {.importc: "mpz_fits_slong_p", header: "<gmp.h>".}
proc mpz_fits_sshort_p*(a2: mpz_srcptr): cint {.importc: "mpz_fits_sshort_p", header: "<gmp.h>".}
proc mpz_fits_sshort_p*(a2: mpz_t): cint {.importc: "mpz_fits_sshort_p", header: "<gmp.h>".}
proc mpz_gcd*(a2: mpz_ptr; a3: mpz_srcptr; a4: mpz_srcptr) {.importc: "mpz_gcd", header: "<gmp.h>".}
proc mpz_gcd*(a2: var mpz_t; a3: mpz_t; a4: mpz_t) {.importc: "mpz_gcd", header: "<gmp.h>".}
proc mpz_gcd_ui*(a2: mpz_ptr; a3: mpz_srcptr; a4: culong): culong {. importc: "mpz_gcd_ui", header: "<gmp.h>".}
proc mpz_gcd_ui*(a2: var mpz_t; a3: mpz_t; a4: culong): culong {. importc: "mpz_gcd_ui", header: "<gmp.h>".}
proc mpz_gcdext*(a2: mpz_ptr; a3: mpz_ptr; a4: mpz_ptr; a5: mpz_srcptr; a6: mpz_srcptr) {.importc: "mpz_gcdext", header: "<gmp.h>".}
proc mpz_gcdext*(a2: var mpz_t; a3: var mpz_t; a4: var mpz_t; a5: mpz_t; a6: mpz_t) {.importc: "mpz_gcdext", header: "<gmp.h>".}
proc mpz_get_d*(a2: mpz_srcptr): cdouble {.importc: "mpz_get_d", header: "<gmp.h>".}
proc mpz_get_d*(a2: mpz_t): cdouble {.importc: "mpz_get_d", header: "<gmp.h>".}
proc mpz_get_d_2exp*(a2: ptr clong; a3: mpz_srcptr): cdouble {. importc: "mpz_get_d_2exp", header: "<gmp.h>".}
proc mpz_get_d_2exp*(a2: ptr clong; a3: mpz_t): cdouble {. importc: "mpz_get_d_2exp", header: "<gmp.h>".}
proc mpz_get_si*(a2: mpz_srcptr): clong {.importc: "mpz_get_si", header: "<gmp.h>".}
proc mpz_get_si*(a2: mpz_t): clong {.importc: "mpz_get_si", header: "<gmp.h>".}
proc mpz_get_str*(a2: cstring; a3: cint; a4: mpz_srcptr): cstring {. importc: "mpz_get_str", header: "<gmp.h>".}
proc mpz_get_str*(a2: cstring; a3: cint; a4: mpz_t): cstring {. importc: "mpz_get_str", header: "<gmp.h>".}
proc mpz_hamdist*(a2: mpz_srcptr; a3: mpz_srcptr): mp_bitcnt_t {. importc: "mpz_hamdist", header: "<gmp.h>".}
proc mpz_hamdist*(a2: mpz_t; a3: mpz_t): mp_bitcnt_t {.importc: "mpz_hamdist", header: "<gmp.h>".}
proc mpz_import*(a2: mpz_ptr; a3: csize_t; a4: cint; a5: csize_t; a6: cint; a7: csize_t; a8: pointer) {.importc: "mpz_import", header: "<gmp.h>".}
proc mpz_import*(a2: var mpz_t; a3: csize_t; a4: cint; a5: csize_t; a6: cint; a7: csize_t; a8: pointer) {.importc: "mpz_import", header: "<gmp.h>".}
proc mpz_init*(a2: mpz_ptr) {.importc: "mpz_init", header: "<gmp.h>".}
proc mpz_init*(a2: var mpz_t) {.importc: "mpz_init", header: "<gmp.h>".}
proc mpz_init2*(a2: mpz_ptr; a3: mp_bitcnt_t) {.importc: "mpz_init2", header: "<gmp.h>".}
proc mpz_init2*(a2: var mpz_t; a3: mp_bitcnt_t) {.importc: "mpz_init2", header: "<gmp.h>".}
proc mpz_inits*(a2: mpz_ptr) {.varargs, importc: "mpz_inits", header: "<gmp.h>".}
proc mpz_inits*(a2: var mpz_t) {.varargs, importc: "mpz_inits", header: "<gmp.h>".}
proc mpz_init_set*(a2: mpz_ptr; a3: mpz_srcptr) {.importc: "mpz_init_set", header: "<gmp.h>".}
proc mpz_init_set*(a2: var mpz_t; a3: mpz_t) {.importc: "mpz_init_set", header: "<gmp.h>".}
proc mpz_init_set_d*(a2: mpz_ptr; a3: cdouble) {.importc: "mpz_init_set_d", header: "<gmp.h>".}
proc mpz_init_set_d*(a2: var mpz_t; a3: cdouble) {.importc: "mpz_init_set_d", header: "<gmp.h>".}
proc mpz_init_set_si*(a2: mpz_ptr; a3: clong) {.importc: "mpz_init_set_si", header: "<gmp.h>".}
proc mpz_init_set_si*(a2: var mpz_t; a3: clong) {.importc: "mpz_init_set_si", header: "<gmp.h>".}
proc mpz_init_set_str*(a2: mpz_ptr; a3: cstring; a4: cint): cint {. importc: "mpz_init_set_str", header: "<gmp.h>".}
proc mpz_init_set_str*(a2: var mpz_t; a3: cstring; a4: cint): cint {. importc: "mpz_init_set_str", header: "<gmp.h>".}
proc mpz_init_set_ui*(a2: mpz_ptr; a3: culong) {.importc: "mpz_init_set_ui", header: "<gmp.h>".}
proc mpz_init_set_ui*(a2: var mpz_t; a3: culong) {.importc: "mpz_init_set_ui", header: "<gmp.h>".}
proc mpz_inp_raw*(a2: mpz_ptr; a3: File): csize_t {.importc: "mpz_inp_raw", header: "<gmp.h>".}
proc mpz_inp_raw*(a2: var mpz_t; a3: File): csize_t {.importc: "mpz_inp_raw", header: "<gmp.h>".}
proc mpz_inp_str*(a2: mpz_ptr; a3: File; a4: cint): csize_t {. importc: "mpz_inp_str", header: "<gmp.h>".}
proc mpz_inp_str*(a2: var mpz_t; a3: File; a4: cint): csize_t {. importc: "mpz_inp_str", header: "<gmp.h>".}
proc mpz_invert*(a2: mpz_ptr; a3: mpz_srcptr; a4: mpz_srcptr): cint {. importc: "mpz_invert", header: "<gmp.h>".}
proc mpz_invert*(a2: var mpz_t; a3: mpz_t; a4: mpz_t): cint {. importc: "mpz_invert", header: "<gmp.h>".}
proc mpz_ior*(a2: mpz_ptr; a3: mpz_srcptr; a4: mpz_srcptr) {.importc: "mpz_ior", header: "<gmp.h>".}
proc mpz_ior*(a2: var mpz_t; a3: mpz_t; a4: mpz_t) {.importc: "mpz_ior", header: "<gmp.h>".}
proc mpz_jacobi*(a2: mpz_srcptr; a3: mpz_srcptr): cint {.importc: "mpz_jacobi", header: "<gmp.h>".}
proc mpz_jacobi*(a2: mpz_t; a3: mpz_t): cint {.importc: "mpz_jacobi", header: "<gmp.h>".}
proc mpz_kronecker_si*(a2: mpz_srcptr; a3: clong): cint {. importc: "mpz_kronecker_si", header: "<gmp.h>".}
proc mpz_kronecker_si*(a2: mpz_t; a3: clong): cint {. importc: "mpz_kronecker_si", header: "<gmp.h>".}
proc mpz_kronecker_ui*(a2: mpz_srcptr; a3: culong): cint {. importc: "mpz_kronecker_ui", header: "<gmp.h>".}
proc mpz_kronecker_ui*(a2: mpz_t; a3: culong): cint {. importc: "mpz_kronecker_ui", header: "<gmp.h>".}
proc mpz_si_kronecker*(a2: clong; a3: mpz_srcptr): cint {. importc: "mpz_si_kronecker", header: "<gmp.h>".}
proc mpz_si_kronecker*(a2: clong; a3: mpz_t): cint {. importc: "mpz_si_kronecker", header: "<gmp.h>".}
proc mpz_ui_kronecker*(a2: culong; a3: mpz_srcptr): cint {. importc: "mpz_ui_kronecker", header: "<gmp.h>".}
proc mpz_ui_kronecker*(a2: culong; a3: mpz_t): cint {. importc: "mpz_ui_kronecker", header: "<gmp.h>".}
proc mpz_lcm*(a2: mpz_ptr; a3: mpz_srcptr; a4: mpz_srcptr) {.importc: "mpz_lcm", header: "<gmp.h>".}
proc mpz_lcm*(a2: var mpz_t; a3: mpz_t; a4: mpz_t) {.importc: "mpz_lcm", header: "<gmp.h>".}
proc mpz_lcm_ui*(a2: mpz_ptr; a3: mpz_srcptr; a4: culong) {. importc: "mpz_lcm_ui", header: "<gmp.h>".}
proc mpz_lcm_ui*(a2: var mpz_t; a3: mpz_t; a4: culong) {.importc: "mpz_lcm_ui", header: "<gmp.h>".}
proc mpz_lucnum_ui*(a2: mpz_ptr; a3: culong) {.importc: "mpz_lucnum_ui", header: "<gmp.h>".}
proc mpz_lucnum_ui*(a2: var mpz_t; a3: culong) {.importc: "mpz_lucnum_ui", header: "<gmp.h>".}
proc mpz_lucnum2_ui*(a2: mpz_ptr; a3: mpz_ptr; a4: culong) {. importc: "mpz_lucnum2_ui", header: "<gmp.h>".}
proc mpz_lucnum2_ui*(a2: var mpz_t; a3: var mpz_t; a4: culong) {. importc: "mpz_lucnum2_ui", header: "<gmp.h>".}
proc mpz_millerrabin*(a2: mpz_srcptr; a3: cint): cint {. importc: "mpz_millerrabin", header: "<gmp.h>".}
proc mpz_millerrabin*(a2: mpz_t; a3: cint): cint {.importc: "mpz_millerrabin", header: "<gmp.h>".}
proc mpz_mod*(a2: mpz_ptr; a3: mpz_srcptr; a4: mpz_srcptr) {.importc: "mpz_mod", header: "<gmp.h>".}
proc mpz_mod*(a2: var mpz_t; a3: mpz_t; a4: mpz_t) {.importc: "mpz_mod", header: "<gmp.h>".}
proc mpz_mul*(a2: mpz_ptr; a3: mpz_srcptr; a4: mpz_srcptr) {.importc: "mpz_mul", header: "<gmp.h>".}
proc mpz_mul*(a2: var mpz_t; a3: mpz_t; a4: mpz_t) {.importc: "mpz_mul", header: "<gmp.h>".}
proc mpz_mul_2exp*(a2: mpz_ptr; a3: mpz_srcptr; a4: mp_bitcnt_t) {. importc: "mpz_mul_2exp", header: "<gmp.h>".}
proc mpz_mul_2exp*(a2: var mpz_t; a3: mpz_t; a4: mp_bitcnt_t) {. importc: "mpz_mul_2exp", header: "<gmp.h>".}
proc mpz_mul_si*(a2: mpz_ptr; a3: mpz_srcptr; a4: clong) {. importc: "mpz_mul_si", header: "<gmp.h>".}
proc mpz_mul_si*(a2: var mpz_t; a3: mpz_t; a4: clong) {.importc: "mpz_mul_si", header: "<gmp.h>".}
proc mpz_mul_ui*(a2: mpz_ptr; a3: mpz_srcptr; a4: culong) {. importc: "mpz_mul_ui", header: "<gmp.h>".}
proc mpz_mul_ui*(a2: var mpz_t; a3: mpz_t; a4: culong) {.importc: "mpz_mul_ui", header: "<gmp.h>".}
proc mpz_nextprime*(a2: mpz_ptr; a3: mpz_srcptr) {.importc: "mpz_nextprime", header: "<gmp.h>".}
proc mpz_nextprime*(a2: var mpz_t; a3: mpz_t) {.importc: "mpz_nextprime", header: "<gmp.h>".}
proc mpz_out_raw*(a2: File; a3: mpz_srcptr): csize_t {.importc: "mpz_out_raw", header: "<gmp.h>".}
proc mpz_out_raw*(a2: File; a3: mpz_t): csize_t {.importc: "mpz_out_raw", header: "<gmp.h>".}
proc mpz_out_str*(a2: File; a3: cint; a4: mpz_srcptr): csize_t {. importc: "mpz_out_str", header: "<gmp.h>".}
proc mpz_out_str*(a2: File; a3: cint; a4: mpz_t): csize_t {. importc: "mpz_out_str", header: "<gmp.h>".}
proc mpz_perfect_power_p*(a2: mpz_srcptr): cint {. importc: "mpz_perfect_power_p", header: "<gmp.h>".}
proc mpz_perfect_power_p*(a2: mpz_t): cint {.importc: "mpz_perfect_power_p", header: "<gmp.h>".}
proc mpz_pow_ui*(a2: mpz_ptr; a3: mpz_srcptr; a4: culong) {. importc: "mpz_pow_ui", header: "<gmp.h>".}
proc mpz_pow_ui*(a2: var mpz_t; a3: mpz_t; a4: culong) {.importc: "mpz_pow_ui", header: "<gmp.h>".}
proc mpz_powm*(a2: mpz_ptr; a3: mpz_srcptr; a4: mpz_srcptr; a5: mpz_srcptr) {. importc: "mpz_powm", header: "<gmp.h>".}
proc mpz_powm*(a2: var mpz_t; a3: mpz_t; a4: mpz_t; a5: mpz_t) {. importc: "mpz_powm", header: "<gmp.h>".}
proc mpz_powm_sec*(a2: mpz_ptr; a3: mpz_srcptr; a4: mpz_srcptr; a5: mpz_srcptr) {. importc: "mpz_powm_sec", header: "<gmp.h>".}
proc mpz_powm_sec*(a2: var mpz_t; a3: mpz_t; a4: mpz_t; a5: mpz_t) {. importc: "mpz_powm_sec", header: "<gmp.h>".}
proc mpz_powm_ui*(a2: mpz_ptr; a3: mpz_srcptr; a4: culong; a5: mpz_srcptr) {. importc: "mpz_powm_ui", header: "<gmp.h>".}
proc mpz_powm_ui*(a2: var mpz_t; a3: mpz_t; a4: culong; a5: mpz_t) {. importc: "mpz_powm_ui", header: "<gmp.h>".}
proc mpz_probab_prime_p*(a2: mpz_srcptr; a3: cint): cint {. importc: "mpz_probab_prime_p", header: "<gmp.h>".}
proc mpz_probab_prime_p*(a2: mpz_t; a3: cint): cint {. importc: "mpz_probab_prime_p", header: "<gmp.h>".}
proc mpz_random*(a2: mpz_ptr; a3: mp_size_t) {.importc: "mpz_random", header: "<gmp.h>".}
proc mpz_random*(a2: var mpz_t; a3: mp_size_t) {.importc: "mpz_random", header: "<gmp.h>".}
proc mpz_random2*(a2: mpz_ptr; a3: mp_size_t) {.importc: "mpz_random2", header: "<gmp.h>".}
proc mpz_random2*(a2: var mpz_t; a3: mp_size_t) {.importc: "mpz_random2", header: "<gmp.h>".}
proc mpz_realloc2*(a2: mpz_ptr; a3: mp_bitcnt_t) {.importc: "mpz_realloc2", header: "<gmp.h>".}
proc mpz_realloc2*(a2: var mpz_t; a3: mp_bitcnt_t) {.importc: "mpz_realloc2", header: "<gmp.h>".}
proc mpz_remove*(a2: mpz_ptr; a3: mpz_srcptr; a4: mpz_srcptr): mp_bitcnt_t {. importc: "mpz_remove", header: "<gmp.h>".}
proc mpz_remove*(a2: var mpz_t; a3: mpz_t; a4: mpz_t): mp_bitcnt_t {. importc: "mpz_remove", header: "<gmp.h>".}
proc mpz_root*(a2: mpz_ptr; a3: mpz_srcptr; a4: culong): cint {. importc: "mpz_root", header: "<gmp.h>".}
proc mpz_root*(a2: var mpz_t; a3: mpz_t; a4: culong): cint {. importc: "mpz_root", header: "<gmp.h>".}
proc mpz_rootrem*(a2: mpz_ptr; a3: mpz_ptr; a4: mpz_srcptr; a5: culong) {. importc: "mpz_rootrem", header: "<gmp.h>".}
proc mpz_rootrem*(a2: var mpz_t; a3: var mpz_t; a4: mpz_t; a5: culong) {. importc: "mpz_rootrem", header: "<gmp.h>".}
# proc mpz_rrandomb*(a2: mpz_ptr; a3: gmp_randstate_t; a4: mp_bitcnt_t) {. importc: "mpz_rrandomb", header: "<gmp.h>".}
# proc mpz_rrandomb*(a2: var mpz_t; a3: gmp_randstate_t; a4: mp_bitcnt_t) {. importc: "mpz_rrandomb", header: "<gmp.h>".}
proc mpz_scan0*(a2: mpz_srcptr; a3: mp_bitcnt_t): mp_bitcnt_t {. importc: "mpz_scan0", header: "<gmp.h>".}
proc mpz_scan0*(a2: mpz_t; a3: mp_bitcnt_t): mp_bitcnt_t {.importc: "mpz_scan0", header: "<gmp.h>".}
proc mpz_scan1*(a2: mpz_srcptr; a3: mp_bitcnt_t): mp_bitcnt_t {. importc: "mpz_scan1", header: "<gmp.h>".}
proc mpz_scan1*(a2: mpz_t; a3: mp_bitcnt_t): mp_bitcnt_t {.importc: "mpz_scan1", header: "<gmp.h>".}
proc mpz_set*(a2: mpz_ptr; a3: mpz_srcptr) {.importc: "mpz_set", header: "<gmp.h>".}
proc mpz_set*(a2: var mpz_t; a3: mpz_t) {.importc: "mpz_set", header: "<gmp.h>".}
proc mpz_set_d*(a2: mpz_ptr; a3: cdouble) {.importc: "mpz_set_d", header: "<gmp.h>".}
proc mpz_set_d*(a2: var mpz_t; a3: cdouble) {.importc: "mpz_set_d", header: "<gmp.h>".}
proc mpz_set_f*(a2: mpz_ptr; a3: mpf_srcptr) {.importc: "mpz_set_f", header: "<gmp.h>".}
proc mpz_set_f*(a2: var mpz_t; a3: mpf_t) {.importc: "mpz_set_f", header: "<gmp.h>".}
proc mpz_set_si*(a2: mpz_ptr; a3: clong) {.importc: "mpz_set_si", header: "<gmp.h>".}
proc mpz_set_si*(a2: var mpz_t; a3: clong) {.importc: "mpz_set_si", header: "<gmp.h>".}
proc mpz_set_str*(a2: mpz_ptr; a3: cstring; a4: cint): cint {. importc: "mpz_set_str", header: "<gmp.h>".}
proc mpz_set_str*(a2: var mpz_t; a3: cstring; a4: cint): cint {. importc: "mpz_set_str", header: "<gmp.h>".}
proc mpz_set_ui*(a2: mpz_ptr; a3: culong) {.importc: "mpz_set_ui", header: "<gmp.h>".}
proc mpz_set_ui*(a2: var mpz_t; a3: culong) {.importc: "mpz_set_ui", header: "<gmp.h>".}
proc mpz_setbit*(a2: mpz_ptr; a3: mp_bitcnt_t) {.importc: "mpz_setbit", header: "<gmp.h>".}
proc mpz_setbit*(a2: var mpz_t; a3: mp_bitcnt_t) {.importc: "mpz_setbit", header: "<gmp.h>".}
proc mpz_sizeinbase*(a2: mpz_srcptr; a3: cint): csize_t {. importc: "mpz_sizeinbase", header: "<gmp.h>".}
proc mpz_sizeinbase*(a2: mpz_t; a3: cint): csize_t {.importc: "mpz_sizeinbase", header: "<gmp.h>".}
proc mpz_sqrt*(a2: mpz_ptr; a3: mpz_srcptr) {.importc: "mpz_sqrt", header: "<gmp.h>".}
proc mpz_sqrt*(a2: var mpz_t; a3: mpz_t) {.importc: "mpz_sqrt", header: "<gmp.h>".}
proc mpz_sqrtrem*(a2: mpz_ptr; a3: mpz_ptr; a4: mpz_srcptr) {. importc: "mpz_sqrtrem", header: "<gmp.h>".}
proc mpz_sqrtrem*(a2: var mpz_t; a3: var mpz_t; a4: mpz_t) {. importc: "mpz_sqrtrem", header: "<gmp.h>".}
proc mpz_sub*(a2: mpz_ptr; a3: mpz_srcptr; a4: mpz_srcptr) {.importc: "mpz_sub", header: "<gmp.h>".}
proc mpz_sub*(a2: var mpz_t; a3: mpz_t; a4: mpz_t) {.importc: "mpz_sub", header: "<gmp.h>".}
proc mpz_sub_ui*(a2: mpz_ptr; a3: mpz_srcptr; a4: culong) {. importc: "mpz_sub_ui", header: "<gmp.h>".}
proc mpz_sub_ui*(a2: var mpz_t; a3: mpz_t; a4: culong) {.importc: "mpz_sub_ui", header: "<gmp.h>".}
proc mpz_ui_sub*(a2: mpz_ptr; a3: culong; a4: mpz_srcptr) {. importc: "mpz_ui_sub", header: "<gmp.h>".}
proc mpz_ui_sub*(a2: var mpz_t; a3: culong; a4: mpz_t) {.importc: "mpz_ui_sub", header: "<gmp.h>".}
proc mpz_submul*(a2: mpz_ptr; a3: mpz_srcptr; a4: mpz_srcptr) {. importc: "mpz_submul", header: "<gmp.h>".}
proc mpz_submul*(a2: var mpz_t; a3: mpz_t; a4: mpz_t) {.importc: "mpz_submul", header: "<gmp.h>".}
proc mpz_submul_ui*(a2: mpz_ptr; a3: mpz_srcptr; a4: culong) {. importc: "mpz_submul_ui", header: "<gmp.h>".}
proc mpz_submul_ui*(a2: var mpz_t; a3: mpz_t; a4: culong) {. importc: "mpz_submul_ui", header: "<gmp.h>".}
proc mpz_swap*(a2: mpz_ptr; a3: mpz_ptr) {.importc: "mpz_swap", header: "<gmp.h>".}
proc mpz_swap*(a2: var mpz_t; a3: var mpz_t) {.importc: "mpz_swap", header: "<gmp.h>".}
proc mpz_tdiv_ui*(a2: mpz_srcptr; a3: culong): culong {.importc: "mpz_tdiv_ui", header: "<gmp.h>".}
proc mpz_tdiv_ui*(a2: mpz_t; a3: culong): culong {.importc: "mpz_tdiv_ui", header: "<gmp.h>".}
proc mpz_tdiv_q*(a2: mpz_ptr; a3: mpz_srcptr; a4: mpz_srcptr) {. importc: "mpz_tdiv_q", header: "<gmp.h>".}
proc mpz_tdiv_q*(a2: var mpz_t; a3: mpz_t; a4: mpz_t) {.importc: "mpz_tdiv_q", header: "<gmp.h>".}
proc mpz_tdiv_q_2exp*(a2: mpz_ptr; a3: mpz_srcptr; a4: mp_bitcnt_t) {. importc: "mpz_tdiv_q_2exp", header: "<gmp.h>".}
proc mpz_tdiv_q_2exp*(a2: var mpz_t; a3: mpz_t; a4: mp_bitcnt_t) {. importc: "mpz_tdiv_q_2exp", header: "<gmp.h>".}
proc mpz_tdiv_q_ui*(a2: mpz_ptr; a3: mpz_srcptr; a4: culong): culong {. importc: "mpz_tdiv_q_ui", header: "<gmp.h>".}
proc mpz_tdiv_q_ui*(a2: var mpz_t; a3: mpz_t; a4: culong): culong {. importc: "mpz_tdiv_q_ui", header: "<gmp.h>".}
proc mpz_tdiv_qr*(a2: mpz_ptr; a3: mpz_ptr; a4: mpz_srcptr; a5: mpz_srcptr) {. importc: "mpz_tdiv_qr", header: "<gmp.h>".}
proc mpz_tdiv_qr*(a2: var mpz_t; a3: var mpz_t; a4: mpz_t; a5: mpz_t) {. importc: "mpz_tdiv_qr", header: "<gmp.h>".}
proc mpz_tdiv_qr_ui*(a2: mpz_ptr; a3: mpz_ptr; a4: mpz_srcptr; a5: culong): culong {. importc: "mpz_tdiv_qr_ui", header: "<gmp.h>".}
proc mpz_tdiv_qr_ui*(a2: var mpz_t; a3: var mpz_t; a4: mpz_t; a5: culong): culong {. importc: "mpz_tdiv_qr_ui", header: "<gmp.h>".}
proc mpz_tdiv_r*(a2: mpz_ptr; a3: mpz_srcptr; a4: mpz_srcptr) {. importc: "mpz_tdiv_r", header: "<gmp.h>".}
proc mpz_tdiv_r*(a2: var mpz_t; a3: mpz_t; a4: mpz_t) {.importc: "mpz_tdiv_r", header: "<gmp.h>".}
proc mpz_tdiv_r_2exp*(a2: mpz_ptr; a3: mpz_srcptr; a4: mp_bitcnt_t) {. importc: "mpz_tdiv_r_2exp", header: "<gmp.h>".}
proc mpz_tdiv_r_2exp*(a2: var mpz_t; a3: mpz_t; a4: mp_bitcnt_t) {. importc: "mpz_tdiv_r_2exp", header: "<gmp.h>".}
proc mpz_tdiv_r_ui*(a2: mpz_ptr; a3: mpz_srcptr; a4: culong): culong {. importc: "mpz_tdiv_r_ui", header: "<gmp.h>".}
proc mpz_tdiv_r_ui*(a2: var mpz_t; a3: mpz_t; a4: culong): culong {. importc: "mpz_tdiv_r_ui", header: "<gmp.h>".}
proc mpz_tstbit*(a2: mpz_srcptr; a3: mp_bitcnt_t): cint {.importc: "mpz_tstbit", header: "<gmp.h>".}
proc mpz_tstbit*(a2: mpz_t; a3: mp_bitcnt_t): cint {.importc: "mpz_tstbit", header: "<gmp.h>".}
proc mpz_ui_pow_ui*(a2: mpz_ptr; a3: culong; a4: culong) {. importc: "mpz_ui_pow_ui", header: "<gmp.h>".}
proc mpz_ui_pow_ui*(a2: var mpz_t; a3: culong; a4: culong) {. importc: "mpz_ui_pow_ui", header: "<gmp.h>".}
...
#     importc: "mpz_urandomm", header: "<gmp.h>".}
proc mpz_xor*(a2: mpz_ptr; a3: mpz_srcptr; a4: mpz_srcptr) {.importc: "mpz_xor", header: "<gmp.h>".}
proc mpz_xor*(a2: var mpz_t; a3: mpz_t; a4: mpz_t) {.importc: "mpz_xor", header: "<gmp.h>".}
proc mpz_limbs_read*(a2: mpz_srcptr): mp_srcptr {.importc: "mpz_limbs_read", header: "<gmp.h>".}
proc mpz_limbs_read*(a2: mpz_t): mp_srcptr {.importc: "mpz_limbs_read", header: "<gmp.h>".}
proc mpz_limbs_write*(a2: mpz_ptr; a3: mp_size_t): mp_ptr {. importc: "mpz_limbs_write", header: "<gmp.h>".}
proc mpz_limbs_write*(a2: var mpz_t; a3: mp_size_t): mp_ptr {. importc: "mpz_limbs_write", header: "<gmp.h>".}
proc mpz_limbs_modify*(a2: mpz_ptr; a3: mp_size_t): mp_ptr {. importc: "mpz_limbs_modify", header: "<gmp.h>".}
proc mpz_limbs_modify*(a2: var mpz_t; a3: mp_size_t): mp_ptr {. importc: "mpz_limbs_modify", header: "<gmp.h>".}
proc mpz_limbs_finish*(a2: mpz_ptr; a3: mp_size_t) {. importc: "mpz_limbs_finish", header: "<gmp.h>".}
proc mpz_limbs_finish*(a2: var mpz_t; a3: mp_size_t) {. importc: "mpz_limbs_finish", header: "<gmp.h>".}
proc mpz_roinit_n*(a2: mpz_ptr; a3: mp_srcptr; a4: mp_size_t): mpz_srcptr {. importc: "mpz_roinit_n", header: "<gmp.h>".}
proc mpz_roinit_n*(a2: var mpz_t; a3: var mp_limb_t; a4: mp_size_t): mpz_srcptr {. importc: "mpz_roinit_n", header: "<gmp.h>".}


proc mpz_abs*(gmp_w: mpz_ptr; gmp_u: mpz_srcptr) {.importc: "mpz_abs", header: "<gmp.h>".}
proc mpz_abs*(gmp_w: var mpz_t; gmp_u: mpz_t) {.importc: "mpz_abs", header: "<gmp.h>".}
proc mpz_fits_uint_p*(gmp_z: mpz_srcptr): cint {.importc: "mpz_fits_uint_p", header: "<gmp.h>".}
proc mpz_fits_uint_p*(gmp_z: mpz_t): cint {.importc: "mpz_fits_uint_p", header: "<gmp.h>".}
proc mpz_fits_ulong_p*(gmp_z: mpz_srcptr): cint {. importc: "mpz_fits_ulong_p", header: "<gmp.h>".}
proc mpz_fits_ulong_p*(gmp_z: mpz_t): cint {.importc: "mpz_fits_ulong_p", header: "<gmp.h>".}
proc mpz_fits_ushort_p*(gmp_z: mpz_srcptr): cint {. importc: "mpz_fits_ushort_p", header: "<gmp.h>".}
proc mpz_fits_ushort_p*(gmp_z: mpz_t): cint {.importc: "mpz_fits_ushort_p", header: "<gmp.h>".}
proc mpz_get_ui*(gmp_z: mpz_srcptr): culong {.importc: "mpz_get_ui", header: "<gmp.h>".}
proc mpz_get_ui*(gmp_z: mpz_t): culong {.importc: "mpz_get_ui", header: "<gmp.h>".}
proc mpz_getlimbn*(gmp_z: mpz_srcptr; gmp_n: mp_size_t): mp_limb_t {. importc: "mpz_getlimbn", header: "<gmp.h>".}
proc mpz_getlimbn*(gmp_z: mpz_t; gmp_n: mp_size_t): mp_limb_t {. importc: "mpz_getlimbn", header: "<gmp.h>".}
proc mpz_neg*(gmp_w: mpz_ptr; gmp_u: mpz_srcptr) {.importc: "mpz_neg", header: "<gmp.h>".}
proc mpz_neg*(gmp_w: var mpz_t; gmp_u: mpz_t) {.importc: "mpz_neg", header: "<gmp.h>".}
proc mpz_perfect_square_p*(gmp_a: mpz_srcptr): cint {. importc: "mpz_perfect_square_p", header: "<gmp.h>".}
proc mpz_perfect_square_p*(gmp_a: mpz_t): cint {. importc: "mpz_perfect_square_p", header: "<gmp.h>".}
proc mpz_popcount*(gmp_u: mpz_srcptr): mp_bitcnt_t {.importc: "mpz_popcount", header: "<gmp.h>".}
proc mpz_popcount*(gmp_u: mpz_t): mp_bitcnt_t {.importc: "mpz_popcount", header: "<gmp.h>".}
proc mpz_set_q*(gmp_w: mpz_ptr; gmp_u: mpq_srcptr) {.importc: "mpz_set_q", header: "<gmp.h>".}
proc mpz_set_q*(gmp_w: var mpz_t; gmp_u: mpq_t) {.importc: "mpz_set_q", header: "<gmp.h>".}
proc mpz_size*(gmp_z: mpz_srcptr): csize_t {.importc: "mpz_size", header: "<gmp.h>".}
proc mpz_size*(gmp_z: mpz_t): csize_t {.importc: "mpz_size", header: "<gmp.h>".}



proc mpq_add*(a2: mpq_ptr; a3: mpq_srcptr; a4: mpq_srcptr) {.importc: "mpq_add", header: "<gmp.h>".}
proc mpq_add*(a2: var mpq_t; a3: mpq_t; a4: mpq_t) {.importc: "mpq_add", header: "<gmp.h>".}
...
proc mpn_gcdext*(a2: var mp_limb_t; a3: var mp_limb_t; a4: ptr mp_size_t; 
    ...
    header: "<gmp.h>".}
proc mpn_get_str*(a2: ptr uint8; a3: cint; a4: mp_ptr; a5: mp_size_t): csize_t {. importc: "mpn_get_str", header: "<gmp.h>".}
proc mpn_get_str*(a2: ptr uint8; a3: cint; a4: var mp_limb_t; a5: mp_size_t): csize_t {. importc: "mpn_get_str", header: "<gmp.h>".}
proc mpn_hamdist*(a2: mp_srcptr; a3: mp_srcptr; a4: mp_size_t): mp_bitcnt_t {. importc: "mpn_hamdist", header: "<gmp.h>".}
proc mpn_hamdist*(a2: var mp_limb_t; a3: var mp_limb_t; a4: mp_size_t): mp_bitcnt_t {. importc: "mpn_hamdist", header: "<gmp.h>".}
...
proc mpq_abs*(gmp_w: mpq_ptr; gmp_u: mpq_srcptr) {.importc: "mpq_abs",
    header: "<gmp.h>".}
proc mpq_abs*(gmp_w: var mpq_t; gmp_u: mpq_t) {.importc: "mpq_abs",
    header: "<gmp.h>".}
proc mpq_neg*(gmp_w: mpq_ptr; gmp_u: mpq_srcptr) {.importc: "mpq_neg",
    header: "<gmp.h>".}
proc mpq_neg*(gmp_w: var mpq_t; gmp_u: mpq_t) {.importc: "mpq_neg",
    header: "<gmp.h>".}
proc mpn_add*(gmp_wp: mp_ptr; gmp_xp: mp_srcptr; gmp_xsize: mp_size_t;
              gmp_yp: mp_srcptr; gmp_ysize: mp_size_t): mp_limb_t {.
    importc: "mpn_add", header: "<gmp.h>".}
proc mpn_add*(gmp_wp: var mp_limb_t; gmp_xp: var mp_limb_t;
              gmp_xsize: mp_size_t; gmp_yp: var mp_limb_t;
              gmp_ysize: mp_size_t): mp_limb_t {.importc: "mpn_add",
    header: "<gmp.h>".}
proc mpn_add_1*(gmp_dst: mp_ptr; gmp_src: mp_srcptr;
                gmp_size: mp_size_t; gmp_n: mp_limb_t): mp_limb_t {.
    importc: "mpn_add_1", header: "<gmp.h>".}
proc mpn_add_1*(gmp_dst: var mp_limb_t; gmp_src: var mp_limb_t;
                gmp_size: mp_size_t; gmp_n: mp_limb_t): mp_limb_t {.
    importc: "mpn_add_1", header: "<gmp.h>".}
proc mpn_cmp*(gmp_xp: mp_srcptr; gmp_yp: mp_srcptr; gmp_size: mp_size_t): cint {.
    importc: "mpn_cmp", header: "<gmp.h>".}
proc mpn_cmp*(gmp_xp: var mp_limb_t; gmp_yp: var mp_limb_t;
              gmp_size: mp_size_t): cint {.importc: "mpn_cmp",
    header: "<gmp.h>".}
